...
const Recommend = () => {
  ...
  const currentMagazines = Object.values(magazines.recommend).filter(magazine => (magazine.title.includes(searchQuery) || magazine.title2.includes(searchQuery))).slice(startIndex, startIndex + itemsPerPage);
  const totalPages = Math.ceil(Object.values(magazines.recommend).filter(magazine => (magazine.title.includes(searchQuery) || magazine.title2.includes(searchQuery))).length / itemsPerPage);
