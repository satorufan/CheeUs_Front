...
const Tmi = () => {
  ...
  const currentMagazines = Object.values(magazines.tmi).filter(magazine => (magazine.title.includes(searchQuery) || magazine.title2.includes(searchQuery))).slice(startIndex, startIndex + itemsPerPage);
  const totalPages = Math.ceil(Object.values(magazines.tmi).filter(magazine => (magazine.title.includes(searchQuery) || magazine.title2.includes(searchQuery))).length / itemsPerPage);
